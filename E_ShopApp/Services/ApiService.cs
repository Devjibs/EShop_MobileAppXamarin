    ...
    public static class ApiService
    {
        public static async Task<bool> RegisterUser(string name, string email, string password)
        {
            ...
            var response = await httpClient.PostAsync
                (AppSettings.ApiUrl + "api/Accounts/Register", content);
        ...
        public static async Task<bool> Login(string email, string password)
        {
            ...
            var content = new StringContent(json, Encoding.UTF8, "application/json");
            var response = await httpClient.PostAsync
                (AppSettings.ApiUrl + "api/Accounts/Login", content);
        ...
        public static async Task<List<Category>> GetCategories()
        {
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/Categories");
        ...
        public static async Task<Product> GetProductById(int productId)
        {
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/Categories/" + productId);
        ...
        public static async Task<List<ProductByCategory>> GetProductByCategory(int categoryId)
        {
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/Products/ProductsByCategory/" + categoryId);
        ...
        public static async Task<List<PopularProduct>> GetPopularProducts()
        {
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/Products/PopularProducts/");
        ...
        public static async Task<bool> AddItemsInCart(AddToCart addToCart)
        {
            ...
            var response = await httpClient.PostAsync
                (AppSettings.ApiUrl + "api/ShoppingCartItems/", content);
        ...
        public static async Task<CartSubTotal> GetCartSubTotal(int userId)
        {
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/ShoppingCartItems/SubTotal/" + userId);
        ...
        public static async Task<List<ShoppingCartItem>> GetShoppingCartItems(int userId)
        {
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/ShoppingCartItems/" + userId);
        ...
        public static async Task<TotalCartItem> GetTotalCartItems(int userId)
        {
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/ShoppingCartItems/TotalItems/" + userId);
        ...
        public static async Task<OrderResponse> PlaceOrder(Order order)
        {
            ...
            var response = await httpClient.PostAsync
                (AppSettings.ApiUrl + "api/Orders/", content);
        ...
        public static async Task<List<OrderByUser>> GetOrdersByUser(int userId)
        {
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/Orders/OrdersByuser/" + userId);
        ...
        public static async Task<List<Order>> GetOrdersDetail(int orderId)
        {
            await TokenValidator.CheckTokenValidity();
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(
            ...
            var response = await httpClient.GetStringAsync(
                    AppSettings.ApiUrl + "api/Orders/OrderDetails/" + orderId);
